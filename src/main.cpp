...
int main() {
    try {
        ...
        Game::addScene("Next_level", 0, new Scene("Next_level", "resources/fonts/arial.ttf", glm::vec2(80.f, 70.f), "Next level: ", 40, glm::vec4(1, 0.5, 0.5, 1)));
        ...
        Game::addScene("Level_3", 3, new Scene("Level_3", "resources/maze/maze_level_3.txt", glm::vec2(0.f, 80.f)));
